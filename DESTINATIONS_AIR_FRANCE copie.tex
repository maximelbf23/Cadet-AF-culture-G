...
% lmodern non disponible, utilisation des polices par défaut
\usepackage{booktabs}
\usepackage{array}
...
\definecolor{updatebg}{RGB}{255,250,230}
\definecolor{updatefr}{RGB}{200,150,0}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{afblue}\textbf{DESTINATIONS --- GROUPE AIR FRANCE 2025/2026 --- VERSION CORRIGÉE}}
...
% Commande correction
\newcommand{\CORR}{\textcolor{afred}{$\blacktriangle$}}

\begin{document}

% ==================== PAGE 1 : TITRE SIMPLE (sans image) ====================
\thispagestyle{empty}
\newgeometry{margin=2cm}
\begin{center}
\vspace*{3cm}
{\fontsize{36}{42}\selectfont\bfseries\color{afblue} DESTINATIONS}\\[0.4cm]
{\fontsize{20}{26}\selectfont\color{afblue} GROUPE AIR FRANCE}\\[0.6cm]
\textcolor{afblue}{\rule{4cm}{3pt}}\textcolor{white!50!black}{\rule{4cm}{3pt}}\textcolor{afred}{\rule{4cm}{3pt}}\\[0.6cm]
{\Large Air France $\bullet$ Transavia France $\bullet$ Air France HOP}\\[0.3cm]
{\large $\sim$170 destinations AF $\bullet$ $\sim$75 pays $\bullet$ Saison 2025/2026}\\[0.5cm]
{\normalsize Document de révision --- PSY0 Cadets Air France}\\[1.5cm]
\begin{tcolorbox}[colback=afred!10,colframe=afred,boxrule=1.5pt,arc=4pt,width=0.7\textwidth]
\centering\small\bfseries
VERSION CORRIGÉE --- Mars 2026\\[4pt]
\normalfont\small
Corrections appliquées : composition SkyTeam (18 membres), flotte Transavia (B737-800 + A320neo),\\
retrait AF d'Orly (29 mars 2026), nombre de destinations ($\sim$170 AF / $\sim$200+ Groupe),\\
Mauritanie vs Maurice, et autres mises à jour factuelles.\\[4pt]
\CORR\ = Correction par rapport à la version précédente
\end{tcolorbox}
\end{center}
\clearpage
\restoregeometry
...
\textbf{AF} = Air France \quad\textbf{|}\quad \textbf{TO} = Transavia France \quad\textbf{|}\quad \textbf{HOP} = Air France HOP \quad\textbf{|}\quad \CORR\ = Correction
\end{tcolorbox}
\vspace{-0.2cm}

% ============ ACTUALITÉS RÉSEAU 2025-2026 ========================
\sectionbanner{afred}{ACTUALITÉS RÉSEAU 2025/2026 --- À CONNAÎTRE ABSOLUMENT}
\addcontentsline{toc}{section}{Actualités Réseau 2025/2026}

\begin{tcolorbox}[colback=updatebg,colframe=updatefr,boxrule=1.5pt,arc=4pt,title={\textbf{FAITS MARQUANTS À RETENIR POUR LE PSY0}},fonttitle=\bfseries\color{white},colbacktitle=updatefr]
\scriptsize
\begin{multicols}{2}
\begin{itemize}[leftmargin=*]\setlength\itemsep{1pt}
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Retrait d'Orly --- 29 mars 2026} : Air France quitte définitivement Paris-Orly. Tous les vols (y compris Outre-mer : Martinique, Guadeloupe, Réunion) transférés à CDG. Transavia reprend le domestique à Orly (Toulouse, Nice, Marseille). Seule exception possible : Corse (DSP).
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Nouvelles destinations long-courrier} : Phuket (nov. 2025), Punta Cana (jan. 2026), Orlando (été 2025, prolongée), Riyad (mai 2025), Las Vegas (été 2026).
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Nouvelle La Première} : suite modulable sur 5 hublots, déployée sur JFK, LAX, SIN, TLV, MIA, HND. Atlanta, Boston, Houston en 2026.
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Wifi Starlink} : déploiement progressif, 30\% flotte fin 2025, 100\% fin 2026. Gratuit pour tous les passagers. 1\up{re} grande compagnie européenne.
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{SkyTeam} : désormais \textbf{18 membres} (ITA Airways sortie fév. 2025 $\rightarrow$ Star Alliance ; Aeroflot exclue 2022 ; Czech Airlines en faillite). Arrivée de SAS (sept. 2024).
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Transavia} : flotte mixte B737-800 + A320neo (22 A320neo fin 2025). Transition vers tout-Airbus en cours. $\sim$14M passagers en 2024.
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Retrait A380} : retiré en 2020-2021 (crise Covid + émissions CO\textsubscript{2}). Question classique PSY0.
\item[\textbf{\color{afred}$\blacktriangleright$}] \textbf{Hiver 2025-2026} : $\sim$800 vols/jour, $\sim$170 destinations, 73 pays. Capacité long-courrier +3\%.
\end{itemize}
\end{multicols}
\end{tcolorbox}
...
\CAP\ Paris Orly & ORY & LFPO & TO \CORR \\
...
\vspace{0.15cm}
\begin{tcolorbox}[colback=afred!8,colframe=afred,boxrule=0.8pt,arc=2pt]
\scriptsize\CORR\ \textbf{Note retrait Orly (29/03/2026)} : À compter de l'été 2026, Air France n'opère plus depuis Orly. Transavia reprend les liaisons domestiques (TLS, MRS, NCE). Les vols Outre-mer AF passent à CDG. Orly = base Transavia uniquement (+ Corse AF sous DSP possible).
\end{tcolorbox}
...
Mauritanie & \CAP\ Nouakch. & NKC & GQNN & 5h30 & 0 \CORR \\
...
\begin{tcolorbox}[colback=afred!8,colframe=afred,boxrule=0.8pt,arc=2pt]
\scriptsize\CORR\ \textbf{Outre-mer depuis CDG} : À partir du 29/03/2026, tous les vols AF Outre-mer (PTP, FDF, RUN, CAY) décollent de CDG (Terminaux 2E/2F), plus d'Orly. 2 vols/jour maintenus vers PTP et FDF en haute saison. Air Caraïbes, Corsair et French Bee restent à Orly.
\end{tcolorbox}
...
\textit{\CORR\ A380 retiré en 2020--2021 (crise Covid + émissions CO\textsubscript{2})}
\end{tcolorbox}

\vspace{0.15cm}

\begin{tcolorbox}[colback=amerlight,colframe=ameror,title={\textbf{TRANSAVIA FRANCE (TO) \CORR}},fonttitle=\bfseries\color{white}]
\begin{tabular}{lll}
\toprule
\textbf{Avion} & \textbf{Sièges} & \textbf{Routes typiques} \\
\midrule
\textbf{B737-800} & 189 & Marrakech, Porto, Athènes \\
\textbf{A320neo} \CORR & 186 & Tenerife, Dubaï, TLS, NCE \\
\bottomrule
\end{tabular}\\[0.1cm]
\textit{Cabine : classe unique (Economy).}\\
\textit{\CORR\ Flotte mixte Boeing + Airbus (22 A320neo fin 2025,}\\
\textit{transition vers tout-Airbus en cours). $\sim$91 avions au total.}\\
\textit{B737 MAX 8 = Transavia Pays-Bas, PAS Transavia France.}
\end{tcolorbox}

\begin{tcolorbox}[colback=aflight,colframe=afblue,title={\textbf{AIR FRANCE HOP}},fonttitle=\bfseries\color{white}]
\begin{tabular}{lll}
\toprule
\textbf{Avion} & \textbf{Sièges} & \textbf{Rôle} \\
\midrule
\textbf{Embraer 170} & 76 & Feed CDG, régional \\
\textbf{Embraer 190} & 100 & Caen, Strasbourg \\
\bottomrule
\end{tabular}\\[0.1cm]
\textit{Filiale régionale d'Air France. Opère sous code AF.}\\
\textit{Rôle : alimenter le hub CDG en correspondances.}
\end{tcolorbox}
...
\textbf{Pistes} & 4 (2 doublets indépendants) \\
 & Piste max : 4\,215 m \\
\textbf{Terminaux AF} & 2E, 2F, 2G \\
\textbf{Passagers} & $\sim$70 M/an (\#1 France, \#3 Europe) \CORR \\
\textbf{Vocation} & Hub unique AF (été 2026) \\
\textbf{Correspondances} & Min. 1h (interligne), 45 min (même cie) \\
\end{tabular}
\end{tcolorbox}

\begin{tcolorbox}[colback=aflight,colframe=afred,title={\textbf{PARIS-ORLY (ORY / LFPO) \CORR}},fonttitle=\bfseries\color{white}]
\begin{tabular}{rl}
\textbf{Ouverture} & 1932 (principal jusqu'en 1974) \\
\textbf{Pistes} & 3 \\
\textbf{Terminaux} & Orly 1, 2, 3, 4 \\
\textbf{Passagers} & $\sim$33 M/an (\#2 France) \\
\textbf{Vocation 2026} & \textbf{Base Transavia} (+ Air Caraïbes, \\
 & Corsair, French Bee, easyJet\ldots) \\
\textbf{\CORR\ AF quitte} & \textbf{29 mars 2026} --- fin 74 ans d'opérations \\
 & AF à Orly. Tout vers CDG. \\
\end{tabular}
\end{tcolorbox}
...
% ============ SKYTEAM ================================
\sectionbanner{eurblue}{HUBS SKYTEAM --- RÉSEAU PARTENAIRES \CORR}
\addcontentsline{toc}{section}{Hubs SkyTeam}

\begin{tcolorbox}[colback=eurlight,colframe=afblue,title={\textbf{Les 18 membres SkyTeam et leurs hubs principaux \CORR\ (mis à jour mars 2026)}},fonttitle=\bfseries\color{white}]
\scriptsize
\begin{multicols}{3}
\begin{tabular}{lll}
\toprule
...
Air Europa \CORR & Madrid & MAD \\
\rowcolor{aflight} China Eastern & Shanghai & PVG \\
Vietnam Airlines & Hanoï & HAN \\
\rowcolor{aflight} Saudia & Djeddah & JED \\
Garuda Indonesia & Jakarta & CGK \\
\rowcolor{aflight} China Airlines & Taipei & TPE \\
SAS \CORR & Copenhague & CPH \\
\rowcolor{aflight} Tarom & Bucarest & OTP \\
Middle East Al. & Beyrouth & BEY \\
\rowcolor{aflight} Kenya Airways & Nairobi & NBO \\
XiamenAir & Xiamen & XMN \\
\rowcolor{aflight} Aerolíneas Arg. & Buenos Aires & EZE \\
Virgin Atlantic \CORR & Londres LHR & LHR \\
\bottomrule
\end{tabular}
\end{multicols}
\vspace{0.1cm}
\CORR\ \textbf{Sorties récentes :} Aeroflot (exclue 2022, invasion Ukraine) --- Czech Airlines (faillite) --- ITA Airways (sortie fév. 2025 $\rightarrow$ Lufthansa/Star Alliance).\\
\CORR\ \textbf{Entrées récentes :} SAS (sept. 2024) --- Virgin Atlantic --- Air Europa.
\end{tcolorbox}
...
6 & CDG -- DXB (Dubaï) & 16 (2+/j) & A350-900 & 6h30 \\
\rowcolor{aflight} 7 & CDG -- BKK (Bangkok) & 14 (2/j) & A350-900 & 11h15 \\
8 & CDG -- CMN (Casablanca) & 14 & A321/B777 & 3h05 \\
\rowcolor{aflight} 9 & CDG -- FDF (Fort-de-Fr.) & 14 (2/j) & B777-300ER & 8h30 \CORR \\
...
\begin{tcolorbox}[colback=afred!8,colframe=afred,boxrule=0.8pt,arc=2pt]
\scriptsize\CORR\ \textbf{Route \#9 corrigée :} Les vols Fort-de-France partent désormais de CDG (et non Orly) à partir du 29/03/2026.\\
\CORR\ \textbf{Route \#6 mise à jour :} Dubaï passe à 16 fréquences/semaine (contre 14 précédemment).
\end{tcolorbox}

% ============ QCM DESTINATIONS ========================
\newpage
\sectionbanner{afrgreen}{QCM --- DESTINATIONS \& CODES (20 questions) \CORR}
...
a) 100 \quad b) 150 \quad c) 170 \quad d) 300 \CORR
...
\textbf{Q14.} Transavia France opère quel(s) type(s) d'avion ? \CORR\\
a) B737-800 uniquement \quad b) B737-800 + A320neo \\
c) A320neo uniquement \quad d) Embraer 190

\textbf{Q15.} Combien de pistes Paris CDG possède-t-il~?\\
a) 2 \quad b) 3 \quad c) 4 \quad d) 5

\textbf{Q16.} \CORR\ Combien de membres compte SkyTeam en 2025/2026 ?\\
a) 15 \quad b) 18 \quad c) 19 \quad d) 21

\textbf{Q17.} \CORR\ Quelle date marque le retrait d'AF d'Orly ?\\
a) 1\up{er} janvier 2026 \quad b) 29 mars 2026 \\
c) 1\up{er} juin 2026 \quad d) AF n'a pas quitté Orly

\textbf{Q18.} \CORR\ Quel avion a été retiré par AF en 2020-2021 ?\\
a) B747 \quad b) A340 \quad c) A380 \quad d) Concorde

\textbf{Q19.} \CORR\ Quelle compagnie n'est PAS membre SkyTeam ?\\
a) Virgin Atlantic \quad b) ITA Airways \\
c) Kenya Airways \quad d) SAS

\textbf{Q20.} \CORR\ Quelle destination a ouvert en nov. 2025 ?\\
a) Las Vegas \quad b) Phuket \quad c) Orlando \quad d) Riyad

\vspace{0.3cm}
\begin{tcolorbox}[colback=afrlight,colframe=afrgreen,title={\textbf{CORRIGÉS}},fonttitle=\bfseries\color{white}]
\begin{tabular}{cccccccccc}
Q1 & Q2 & Q3 & Q4 & Q5 & Q6 & Q7 & Q8 & Q9 & Q10 \\
b & c & c\CORR & c & c & b & b & c & b & c \\
\midrule
Q11 & Q12 & Q13 & Q14 & Q15 & Q16 & Q17 & Q18 & Q19 & Q20 \\
c & c & c & b\CORR & c & b\CORR & b\CORR & c\CORR & b\CORR & b\CORR \\
\end{tabular}
\end{tcolorbox}
...
% ============ STATISTIQUES ============================
\vspace{0.3cm}
\begin{tcolorbox}[colback=aflight,colframe=afblue,title={\textbf{STATISTIQUES RÉSEAU --- À RETENIR POUR LE PSY0 \CORR}},fonttitle=\bfseries\color{white}]
\begin{multicols}{3}
\scriptsize
\begin{itemize}\setlength\itemsep{0pt}
\item[\textbf{$\sim$170}] destinations AF (seule) \CORR
\item[\textbf{$\sim$200+}] dest. Groupe (AF+TO+HOP)
\item[\textbf{$\sim$75}] pays desservis \CORR
...
\item[\textbf{16}] destinations en Asie-Pac. \CORR
\item[\textbf{25}] villes France métro
\item[\textbf{4}] territoires outre-mer
\item Vol le plus court : CDG--BRU (\textbf{1h05})
\item Vol le plus long : CDG--PPT (\textbf{$\sim$21h})
\item Hub unique AF : \textbf{CDG} (T2E/F/G) \CORR
\item Code OACI France : \textbf{LF}
\item Code OACI USA : \textbf{K}
\item Alliance : \textbf{SkyTeam} (\textbf{18} membres) \CORR
\item Flotte TO : B737-800 + \textbf{A320neo} \CORR
\item A380 : retiré 2020--2021 \CORR
\item CDG : \#1 FR, \textbf{\#3 Europe} \CORR
\end{itemize}
\end{multicols}
\end{tcolorbox}
...
% ============ CHANGELOG ==============================
\vspace{0.3cm}
\begin{tcolorbox}[colback=afred!5,colframe=afred,title={\textbf{CHANGELOG --- CORRECTIONS APPORTÉES (v2 --- Mars 2026)}},fonttitle=\bfseries\color{white}]
\scriptsize
\begin{multicols}{2}
\begin{enumerate}[leftmargin=*]\setlength\itemsep{1pt}
\item \textbf{SkyTeam} : 19 $\rightarrow$ 18 membres. Retrait Aeroflot, Czech Airlines, ITA Airways. Ajout Air Europa, Virgin Atlantic, SAS.
\item \textbf{Transavia} : ``100\% Boeing'' $\rightarrow$ flotte mixte B737-800 + A320neo. B737 MAX 8 = Transavia NL uniquement.
\item \textbf{Orly} : précision retrait AF le 29/03/2026. ORY = base Transavia. Vols Outre-mer AF $\rightarrow$ CDG.
\item \textbf{Destinations} : $\sim$200 $\rightarrow$ $\sim$170 (AF seule) / $\sim$200+ (Groupe). Pays : $\sim$80 $\rightarrow$ $\sim$75.
\item \textbf{CDG} : précision \#3 Europe (derrière Istanbul et Londres). Pistes : 2 doublets indépendants.
\item \textbf{Mauritanie} : correction ``Maurice'' $\rightarrow$ ``Mauritanie'' dans tableau Afrique Ouest.
\item \textbf{QCM} : 15 $\rightarrow$ 20 questions (5 ajoutées sur actualités 2025-2026). Réponse Q3 et Q14 corrigées.
\item \textbf{Actualités} : section ajoutée (retrait Orly, Phuket, La Première, Wifi Starlink, retrait A380).
\item \textbf{Air France HOP} : encadré ajouté dans la section flotte.
\item \textbf{Top Routes} : FDF via CDG (plus Orly), Dubaï 16 fréq/sem.
\end{enumerate}
\end{multicols}
\end{tcolorbox}
...
{\scriptsize Sources : Air France Corporate 2025/2026, Transavia.com, SkyTeam.com, Wikipedia, FlightConnections, programmes hiver 2025-2026 et été 2025/2026.}\\
{\scriptsize Distances et durées approximatives. Certaines destinations sont saisonnières. \CAP\ = Capitale du pays. \CORR\ = Correction v2.}\\[0.15cm]
{\small\textbf{Document préparé pour la révision PSY0 Cadets Air France --- Mars 2026 --- Version corrigée}}
\end{center}
